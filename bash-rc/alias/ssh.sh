...
alias sshaid='ssh ravi@ai-dev'
alias sshgpt='ssh ubuntu@ai-dev'
alias sshag='ssh ubuntu@ag-linux'
...
alias sshtagaadmin='ssh admin-taga@taga-prod'
alias sshtagasys='ssh sys-taga@taga-prod'
alias sshtagadev='ssh dev-taga@taga-prod'